...
with(this){return _c('p',[_c('strong',[_v("Use case: UC10 — Export persons to CSV")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS:")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to export all persons and details to a CSV file.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook exports the persons to a CSV file.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook displays a message to confirm that all persons have been exported to a CSV file.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.3.0")]),_v(", generated on Sat, 23 Mar 2024, 22:03:49 GMT+8]")])])])}
}];
