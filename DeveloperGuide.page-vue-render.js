...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to add a new person.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook prompts the user to input details for the new person.")])]),_v(" "),_c('li',[_c('p',[_v("User inputs details for the new person.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook saves the new person's information.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook confirms the addition of the new person.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list persons.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook shows a list of persons.")])]),_v(" "),_c('li',[_c('p',[_v("User views the list of persons.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to edit a specific person.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook prompts the user to select the person to edit.")])]),_v(" "),_c('li',[_c('p',[_v("User selects the person to edit.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook displays the details of the selected person.")])]),_v(" "),_c('li',[_c('p',[_v("User updates the details of the person.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook saves the updated details.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook confirms the successful update.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The list is empty.")]),_v(" "),_c('ul',[_c('li',[_v("2a1. AddressBook displays a message indicating that the list is empty.")])]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. The selected person does not exist.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. AddressBook displays an error message indicating that the person does not exist.")]),_v(" "),_c('p',[_v("Use case resumes at step 2.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to find a specific person.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook prompts the user to input search criteria.")])]),_v(" "),_c('li',[_c('p',[_v("User inputs search criteria.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook searches for persons matching the criteria.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook displays a list of persons matching the criteria.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("5a. No persons match the search criteria.")])]),_v(" "),_c('li',[_c('p',[_v("5a1. AddressBook displays a message indicating that no persons match the criteria.")])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to clear all persons.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook prompts the user to confirm the action.")])]),_v(" "),_c('li',[_c('p',[_v("User confirms the action.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook clears all persons.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to exit the application.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook prompts the user to confirm the exit.")])]),_v(" "),_c('li',[_c('p',[_v("User confirms the exit.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook exits the application.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.3.0")]),_v(", generated on Tue, 27 Feb 2024, 13:04:07 GMT+8]")])])])}
}];
