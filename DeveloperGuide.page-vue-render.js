...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list contacts")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook shows a list of contacts")])]),_v(" "),_c('li',[_c('p',[_v("User requests to delete a specific contact in the list")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook deletes the contact")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('strong',[_v("Use case: Add")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to add a new contact and inputs details for the new contact.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook saves the new contact's information.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook confirms the addition of the new contact.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. User does not input enough parameters along with the contact.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. AddressBook prompts the user on the proper usage of the command.")]),_v(" "),_c('p',[_v("Step 1a1 is repeated until the data entered is correct.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list contacts.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook shows a list of contacts.")])]),_v(" "),_c('li',[_c('p',[_v("User views the list of contacts.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('p',[_c('strong',[_v("Use case: Edit")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to edit a specific contact with updated details.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook saves the updated details.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook confirms the successful update.")]),_v(" "),_c('p',[_v("Use case ends.\nx\n"),_c('strong',[_v("Extensions")])])])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. User does not input enough parameters along with the contact.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. AddressBook prompts the user on the proper usage of the command.")]),_v(" "),_c('p',[_v("Step 1a1 is repeated until the data entered is correct.")])])])]),_v(" "),_c('li',[_c('p',[_v("1b. The selected contact does not exist.")]),_v(" "),_c('ul',[_c('li',[_v("1b1. AddressBook displays an error message indicating that the contact does not exist.")])]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to find a specific contact matching the search criteria.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook displays a list of contacts matching the criteria.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. No contacts match the search criteria.")]),_v(" "),_c('ul',[_c('li',[_v("1a1. AddressBook displays a message indicating that no contacts match the criteria.")])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Clear")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to clear all contacts.")])]),_v(" "),_c('li',[_c('p',[_v("AddressBook clears all contacts and displays a message indicating that all contacts have been cleared.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_v("Should work on any "),_c('em',[_v("mainstream OS")]),_v(" as long as it has Java "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("11")]),_v(" or above installed.")]),_v(" "),_c('li',[_v("Should be able to hold up to 1000 contacts without a noticeable sluggishness in performance for typical usage.")]),_v(" "),_c('li',[_v("A user with above average typing speed for regular English text (i.e. not code, not system admin commands) should be able to accomplish most of the tasks faster using commands than using the mouse.")]),_v(" "),_c('li',[_v("A user should be able to import up to 1000 contacts from an external source without a noticeable sluggishness in performance for typical usage.")]),_v(" "),_c('li',[_v("The application should provide comprehensive documentation and help resources to assist users in understanding how to use the software effectively.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('em',[_v("{More to be added}")])])}
},function anonymous(
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.3.0")]),_v(", generated on Wed, 28 Feb 2024, 23:07:03 GMT+8]")])])])}
}];
